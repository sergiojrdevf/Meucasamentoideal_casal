<?php
	...
	<div class="space-default">
		<div class="container">
			...
			<div class="hidde gallery  gallery-five less-centered">	
				<?php
					$args = array(
						'posts_per_page' => -1,
						'post_type' => 'albunsdefotos'
			...
			<a style="margin-top: 20px;" href="<?php echo home_url('/nossas-fotos') ?>" class="mg-bottom btn btn-theme btn-small float-right">Ver todas as fotos</a>
